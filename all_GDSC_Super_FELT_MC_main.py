        ...
        if len(origin_GDSCE) != 0:
            ...
            for iters in range(max_iter):
                ...
                for train_index, test_index in skf.split(GDSCE.values, Y):
                    ...
                    X_trainM, X_valM, X_trainC, X_valC, Y_train, Y_val \
                        = train_test_split(X_trainM,X_trainC, Y_train, test_size=0.2, random_state=42,stratify=Y_train)
                    ...
                    trainDataset = torch.utils.data.TensorDataset(torch.FloatTensor(X_trainM), torch.FloatTensor(X_trainC),
                    ...
                    for cl_epoch in range(Classifier_epoch):
                        ...
                        with torch.no_grad():
                            ...
                            intergrated_val_omics = torch.cat((encoded_val_M, encoded_val_C), 1)
...
data_dir = '/GDSC/'
save_results = '/Super_FELT_MC_GDSC_results/'
